...
generate: build
	...
	$Q bin/step-tpm-plugin completion bash > completions/bash_completion
	$Q bin/step-tpm-plugin completion fish > completions/fish_completion
	$Q bin/step-tpm-plugin completion powershell > completions/powershell_completion
	$Q bin/step-tpm-plugin completion zsh > completions/zsh_completion
...
fmt:
	$Q goimports --local github.com/smallstep/step-tpm-plugin  -l -w $(SRC)
